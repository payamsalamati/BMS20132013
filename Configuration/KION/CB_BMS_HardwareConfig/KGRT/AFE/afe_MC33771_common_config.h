...
#define AFE_CONNECTED_TEMPSENS                 ((uint8_t)0b0001110)
#define AFE_CONNECTED_BAL_TEMPSENS             ((uint8_t)0b0000000)
#define AFE_CONNECTED_APP_TEMPSENS             ((uint8_t)0b0110000)
#define AFE_CONNECTED_GPIO_OUTPUTS             ((uint8_t)0b1000001)
#define AFE_NUM_CONNECTED_CELLS_1ST_AFE        7u
#define AFE_NUM_CONNECTED_TEMPSENS_1ST_AFE     3u
#define AFE_NUM_CONNECTED_BAL_TEMPSENS_1ST_AFE 0u
#define AFE_NUM_CONNECTED_APP_TEMPSENS_1ST_AFE 2u
