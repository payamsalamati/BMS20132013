 ...
 * @unit: uint8_t
 */
#define CELL_MODULE_CONFIG_MAX_MODULE_NO_OF_CELLS_SERIAL     15u
#define CELL_MODULE_CONFIG_MIN_MODULE_NO_OF_CELLS_SERIAL     7u
#define CELL_MODULE_CONFIG_DEFAULT_MODULE_NO_OF_CELLS_SERIAL 15u
 ...
 * @unit: uint8_t
 */
#define CELL_MODULE_CONFIG_MAX_STRING_NO_OF_MODULES_PARALLEL 8U
