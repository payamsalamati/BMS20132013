...
#define AFE_TWO_AFES_ON_ONE_CSC   CONFIG_DISABLED
#define AFE_NUMBER_OF_AFE_PER_CSC 1u
...
#define AFE_V_STACK_THRE             3000  // V_stack_thre may bein the range of a few hundred mV. See V_VPWR_CT in datasheet
...
#define AFE_MC33771_VCELL_MIN                 2500.0  //[mV] according to datasheet

#if((defined(DEBUG) && !defined(UNIT_TEST)) || defined(HIL_CONFIGURATION))
#define AFE_MC33771_Vleak_DIAG 160.0  // mV
#else
...
#define AFE_MC33771_SYS_CFG1_I_MEAS_EN     0b1u    // Bit 9 --> Enable for current measurement chain; 0 = off
#define AFE_MC33771_SYS_CFG1_CB_AUTO_PAUSE 0b0u    // Bit 8 --> Disables cell balance during the conversion cycle; \
                                                   // 0b1 = CB switches are forced off each time a cyclic measurement is performed, \
                                                   // reserved on afe type MC33771
...
#define AFE_MC33771_SYS_CFG1_BIT0_RESERVED 0b1u    // Bit 0 is reserved and has to be 1
#define AFE_SYS_CFG1_CONFIG                (((uint16_t)AFE_MC33771_SYS_CFG1_CYCLIC_TIMER << AFE_MC33771x_CYCLIC_TIMER_POSITION) \
                             ...
                             | ((uint16_t)AFE_MC33771_SYS_CFG1_I_MEAS_EN << AFE_MC33771_SYS_CFG1_I_MEAS_EN_POSITION)            \
                             | ((uint16_t)AFE_MC33771_SYS_CFG1_CB_AUTO_PAUSE << AFE_MC33771x_CB_AUTO_PAUSE_POSITION)            \
                             ...
                             | ((uint16_t)AFE_MC33771_SYS_CFG1_BIT0_RESERVED))
/***************************/

/********* SYS_CFG2 *********/
// Bit 13 - 15 -- > reserved, Bit 10 - 12 -- > PREVIOS_STATE
...
#define AFE_MC33771_SYS_CFG2_TIMEOUT_COMM 0b11u                                                // Bit 4 - 5 --> No communication timeout; 0b11 = 256ms \
                                                  // Bit 2 - 3 --> Reserved
#define AFE_MC33771_SYS_CFG2_NUMB_ODD     (CELL_MODULE_CONFIG_MODULE_NO_OF_CELLS_SERIAL % 2u)  // Bit 1 --> Odd number of cells in the cluster; 1 = Odd configuration
#define AFE_MC33771_SYS_CFG2_HAMM_EMCOD   0b0u                                                 // Bit 0 --> Hamming encoders; 0 = Decode - the DED Hamming decoders fulfill their job
 ...
 **/
#define GPIO0_CFG            0b11u
#define GPIO1_CFG            0b00u
#define GPIO2_CFG            0b00u
#define GPIO3_CFG            0b00u
#define GPIO4_CFG            0b00u
#define GPIO5_CFG            0b00u
#define GPIO6_CFG            0b11u
#define AFE_GPIO_CFG1_CONFIG (((uint16_t)GPIO0_CFG << AFE_MC33771_GPIO0_CFG_POS)   \
                              | ((uint16_t)GPIO1_CFG << AFE_MC33771_GPIO1_CFG_POS) \
                              | ((uint16_t)GPIO2_CFG << AFE_MC33771_GPIO2_CFG_POS) \
                              | ((uint16_t)GPIO3_CFG << AFE_MC33771_GPIO3_CFG_POS) \
                              | ((uint16_t)GPIO4_CFG << AFE_MC33771_GPIO4_CFG_POS) \
                              | ((uint16_t)GPIO5_CFG << AFE_MC33771_GPIO5_CFG_POS) \
                              | ((uint16_t)GPIO6_CFG << AFE_MC33771_GPIO6_CFG_POS))
...
#define AFE_CONNECTED_CELLS ((uint16_t)0b0011111111111111)
...
#define AFE_CONNECTED_APP_TEMPSENS ((uint8_t)0b0000000)  // @req CB-79076
#else
#define AFE_CONNECTED_TEMPSENS     ((uint8_t)0b0011100)  // @req CB-79076
#define AFE_CONNECTED_BAL_TEMPSENS ((uint8_t)0b0000000)  // @req CB-79076
#define AFE_CONNECTED_APP_TEMPSENS ((uint8_t)0b0100010)  // @req CB-79076
#endif

#define AFE_CONNECTED_GPIO_OUTPUTS             ((uint8_t)0b1000001)
#define AFE_NUM_CONNECTED_CELLS_1ST_AFE        14u
#define AFE_NUM_CONNECTED_TEMPSENS_1ST_AFE     4u
#define AFE_NUM_CONNECTED_BAL_TEMPSENS_1ST_AFE 1u
